...
# Purpose:
Generate the output of `jMtkFileLGID` for testing purposes. Test 120: For a MISR `GP_GMP` file.
...
julia> include(JMtk15_test * "src/jMtkFileLGID_tst_120.jl")
jMtkFileLGID_tst_120

julia> lgid = jMtkFileLGID_tst_120();

julia> @test lgid == "MISR_AM1_GP_GMP_P168_O068050_F03_0013.hdf"
Test Passed
```
"""
function jMtkFileLGID_tst_120()
