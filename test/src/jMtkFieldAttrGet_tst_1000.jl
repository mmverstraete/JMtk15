...
# Purpose:
Generate the output of `jMtkFieldAttrGet` for testing purposes. Test 1000: For a MISR `GP_GMP` file.
...
julia> include(JMtk15_test * "src/jMtkFieldAttrGet_tst_1000.jl")
jMtkFieldAttrGet_tst_1000

julia> attrval = jMtkFieldAttrGet_tst_1000();

julia> @test attrval == -555.0
Test Passed
"""
function jMtkFieldAttrGet_tst_1000()
