...
# Purpose:
Generate the output of `jMtkFieldAttrGet` for testing purposes. Test 1100: For a MISR `GRP_ELLIPSOID_GM` file.
...
julia> include(JMtk15_test * "src/jMtkFieldAttrGet_tst_1100.jl")
jMtkFieldAttrGet_tst_1100

julia> attrval = jMtkFieldAttrGet_tst_1100();

julia> @test attrval == -555.0
Test Passed
```
"""
function jMtkFieldAttrGet_tst_1100()
