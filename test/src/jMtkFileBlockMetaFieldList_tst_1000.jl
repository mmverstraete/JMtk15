...
# Purpose:
Generate the output of `jMtkFileBlockMetaFieldList` for testing purposes. Test 1000: For a MISR `GP_GMP` file.
...
julia> include(JMtk15_test * "src/jMtkFileBlockMetaFieldList_tst_1000.jl")
jMtkFileBlockMetaFieldList_tst_1000

julia> nfields, fieldlist = jMtkFileBlockMetaFieldList_tst_1000();
...
```
"""
function jMtkFileBlockMetaFieldList_tst_1000()
