...
# Purpose:
Generate the output of `jMtkFileGridToNativeFieldList` for testing purposes. Test 1500: For a MISR `GRP_RCCM_GM` file.
...
julia> include(JMtk15_test * "src/jMtkFileGridToNativeFieldList_tst_1500.jl")
jMtkFileGridToNativeFieldList_tst_1500

julia> nfields, fieldlist = jMtkFileGridToNativeFieldList_tst_1500();
...
```
"""
function jMtkFileGridToNativeFieldList_tst_1500()
