...
# Purpose:
Generate the output of `jMtkFileGridToResolution` for testing purposes. Test 1500: For a MISR `GRP_RCCM_GM` file.
...
julia> include(JMtk15_test * "src/jMtkFileGridToResolution_tst_1500.jl")
jMtkFileGridToResolution_tst_1500

julia> resolution = jMtkFileGridToResolution_tst_1500();

julia> @test resolution == 1100
Test Passed
```
"""
function jMtkFileGridToResolution_tst_1500()
