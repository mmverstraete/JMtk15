...
# Purpose:
Generate the output of `jMtkFileLGID` for testing purposes. Test 1500: For a MISR `GRP_RCCM_GM` file.
...
julia> include(JMtk15_test * "src/jMtkFileLGID_tst_1500.jl")
jMtkFileLGID_tst_1500

julia> lgid = jMtkFileLGID_tst_1500();

julia> @test lgid == "MISR_AM1_GRP_RCCM_GM_P168_O068050_AA_F04_0025.hdf"
Test Passed
```
"""
function jMtkFileLGID_tst_1500()
