...
# Purpose:
Generate the output of `jMtkFileToBlockRange` for testing purposes. Test 1300: For a MISR `GRP_TERRAIN_GM` file.
...
julia> include(JMtk15_test * "src/jMtkFileToBlockRange_tst_1300.jl")
jMtkFileToBlockRange_tst_1300

julia> start_block, end_block = jMtkFileToBlockRange_tst_1300();

julia> @test (start_block, end_block) == (19, 162)
Test Passed
```
"""
function jMtkFileToBlockRange_tst_1300()
