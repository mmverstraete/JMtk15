...
# Purpose:
Generate the output of `jMtkFileToBlockRange` for testing purposes. Test 2300: For a MISR `TC_CLOUD` file.
...
julia> include(JMtk15_test * "src/jMtkFileToBlockRange_tst_2300.jl")
jMtkFileToBlockRange_tst_2300

julia> start_block, end_block = jMtkFileToBlockRange_tst_2300();

julia> @test (start_block, end_block) == (19, 162)
Test Passed
```
"""
function jMtkFileToBlockRange_tst_2300()
