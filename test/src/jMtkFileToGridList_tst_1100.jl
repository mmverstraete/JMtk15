...
# Purpose:
Generate the output of `jMtkFileToGridList` for testing purposes. Test 1100: For a MISR `GRP_ELLIPSOID_GM` file.
...
julia> include(JMtk15_test * "src/jMtkFileToGridList_tst_1100.jl")
jMtkFileToGridList_tst_1100

julia> ngrids, gridlist = jMtkFileToGridList_tst_1100();
...
```
"""
function jMtkFileToGridList_tst_1100()
