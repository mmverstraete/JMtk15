...
# Purpose:
Generate the output of `jMtkFileToOrbit` for testing purposes. Test 1100: For a MISR `GRP_ELLIPSOID_GM` file.
...
julia> include(JMtk15_test * "src/jMtkFileToOrbit_tst_1100.jl")
jMtkFileToOrbit_tst_1100

julia> orbit = jMtkFileToOrbit_tst_1100();

julia> @test orbit == 68050
Test Passed
```
"""
function jMtkFileToOrbit_tst_1100()
