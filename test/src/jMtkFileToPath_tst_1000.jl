...
# Purpose:
Generate the output of `jMtkFileToPath` for testing purposes. Test 1000: For a MISR `GP_GMP` file.
...
julia> include(JMtk15_test * "src/jMtkFileToPath_tst_1000.jl")
jMtkFileToPath_tst_1000

julia> path = jMtkFileToPath_tst_1000();

julia> @test path == 168
Test Passed
```
"""
function jMtkFileToPath_tst_1000()
