...
# Purpose:
Generate the output of `jMtkFileToPath` for testing purposes. Test 1100: For a MISR `GRP_ELLIPSOID_GM` file.
...
julia> include(JMtk15_test * "src/jMtkFileToPath_tst_1100.jl")
jMtkFileToPath_tst_1100

julia> path = jMtkFileToPath_tst_1100();

julia> @test path == 168
Test Passed
```
"""
function jMtkFileToPath_tst_1100()
