...
# Purpose:
Generate the output of `jMtkFileVersion` for testing purposes. Test 2300: For a MISR `TC_CLOUD` file.
...
julia> include(JMtk15_test * "src/jMtkFileVersion_tst_2300.jl")
jMtkFileVersion_tst_2300

julia> fversion = jMtkFileVersion_tst_2300();

julia> @test fversion == "F01_0001"
Test Passed
```
"""
function jMtkFileVersion_tst_2300()
