...
# Purpose:
Generate the output of `jMtkFindFileList` for testing purposes. Test 1100: For a MISR `GRP_ELLIPSOID_GM` file.
...
julia> include(JMtk15_test * "src/jMtkFindFileList_tst_1100.jl")
jMtkFindFileList_tst_1100

julia> filecnt, filenames = jMtkFindFileList_tst_1100();
...
```
"""
function jMtkFindFileList_tst_1100()
