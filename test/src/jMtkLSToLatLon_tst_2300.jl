...
# Purpose:
Generate the output of `jMtkLSToLatLon` for testing purposes. Test 2300: For a MISR `TC_CLOUD` file.
...
julia> include(JMtk15_test * "src/jMtkLSToLatLon_tst_2300.jl")
jMtkLSToLatLon_tst_2300

julia> latitude, longitude = jMtkLSToLatLon_tst_2300();

julia> @test (latitude, longitude) == (-21.872392767809703, 32.70617471105444)
Test Passed
```
"""
function jMtkLSToLatLon_tst_2300()
