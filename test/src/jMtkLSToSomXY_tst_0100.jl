...
# Purpose:
Generate the output of `jMtkLSToSomXY` for testing purposes. Test 0100: For a MISR `AGP` file.
...
julia> include(JMtk15_test * "src/jMtkLSToSomXY_tst_0100.jl")
jMtkLSToSomXY_tst_0100

julia> somx, somy = jMtkLSToSomXY_tst_0100();

julia> @test (somx, somy) == (2.292411e7, -405350.0)
Test Passed
```
"""
function jMtkLSToSomXY_tst_0100()
