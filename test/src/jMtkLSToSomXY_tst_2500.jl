...
# Purpose:
Generate the output of `jMtkLSToSomXY` for testing purposes. Test 2500: For a MISR `AS_LAND` file.
...
julia> include(JMtk15_test * "src/jMtkLSToSomXY_tst_2500.jl")
jMtkLSToSomXY_tst_2500

julia> somx, somy = jMtkLSToSomXY_tst_2500();

julia> @test (somx, somy) == (2.287912e7, -358600.0)
Test Passed
```
"""
function jMtkLSToSomXY_tst_2500()
